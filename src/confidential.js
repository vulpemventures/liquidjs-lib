...
const secp256k1_zkp_1 = __importDefault(require("@vulpemventures/secp256k1-zkp"));
 ...
 */
async function rangeProofWithNonceHash(value, blindingPubkey, ephemeralPrivkey, asset, assetBlindingFactor, valueBlindFactor, valueCommit, scriptPubkey, minValue, exp, minBits) {
    const nonce = await nonceHash(blindingPubkey, ephemeralPrivkey);
    return rangeProof(value, nonce, asset, assetBlindingFactor, valueBlindFactor, valueCommit, scriptPubkey, minValue, exp, minBits);
}
exports.rangeProofWithNonceHash = rangeProofWithNonceHash;
/**
 *  rangeProof computation without nonceHash step.
 */
async function rangeProof(value, nonce, asset, assetBlindingFactor, valueBlindFactor, valueCommit, scriptPubkey, minValue, exp, minBits) {
